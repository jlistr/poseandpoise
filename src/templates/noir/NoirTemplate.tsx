...
export function NoirTemplate({ data }: NoirTemplateProps) {
  const editMode = useEditMode();
  const [selectedPhoto, setSelectedPhoto] = useState<string | null>(null);
  const [activeId, setActiveId] = useState<string | null>(null);
  const accentColor = editMode?.accentColor || '#FFFFFF';
  ...
  return (
    <div
      ...
      style={{
        ...style,
        position: 'relative',
        border: !photo.isVisible ? '2px dashed rgba(255, 255, 255, 0.3)' : '1px solid rgba(255, 255, 255, 0.1)',
        cursor: 'grab',
        overflow: 'hidden',
      }}
      {...attributes}
    >
      ...
      <div {...listeners} style={{ cursor: isDragging ? 'grabbing' : 'grab' }}>
        <img
          ...
          style={{
            ...
            height: 'auto',
            display: 'block',
            filter: !photo.isVisible ? 'grayscale(100%) opacity(0.4)' : 'grayscale(100%)',
      ...
      <button
        ...
        style={{
          ...
          height: '36px',
          borderRadius: '50%',
          background: photo.isVisible ? 'rgba(34, 197, 94, 0.9)' : 'rgba(255, 255, 255, 0.2)',
...
// =============================================================================
// Regular Photo Item (Public View) - With analytics tracking
// =============================================================================
    ...
    >
      <img
        ...
        style={{
          ...
          filter: isHovered ? 'grayscale(100%) brightness(1.1)' : 'grayscale(100%)',
        }}
      />
    </div>
  );
